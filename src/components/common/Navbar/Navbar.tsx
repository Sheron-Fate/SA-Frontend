...
import { selectIsAuthenticated, selectUsername, selectIsModerator } from '../../../features/auth/selectors';
      ...
      <Container fluid>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto">
            ...
            {isModerator && (
              <Nav.Link as={Link} to={ROUTES.MODERATOR_PIGMENTS} className="nav-link">
                {ROUTE_LABELS.MODERATOR_PIGMENTS}
              </Nav.Link>
            )}
