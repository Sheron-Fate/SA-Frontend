...
import { addPigmentToSpectrumAnalysisAsync } from '../../../features/spectrumAnalysisDraft/spectrumAnalysisDraftSlice'
...
const PigmentCard: FC<PigmentCardProps> = ({
  ...
  const handleAdd = async (e: React.MouseEvent) => {
    ...
    await dispatch(addPigmentToSpectrumAnalysisAsync(id))
  }
