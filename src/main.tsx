...
import SpectrumAnalysisDetailPage from './pages/SpectrumAnalysisDetailPage'
import SpectrumAnalysisListPage from './pages/SpectrumAnalysisListPage'
import ProfilePage from './pages/ProfilePage'
import { ModeratorPigmentsPage } from './pages/ModeratorPigmentsPage'
...
const router = createBrowserRouter([
  ...
  {
    path: ROUTES.MODERATOR_PIGMENTS,
    element: (
      <Layout>
        <ModeratorPigmentsPage />
      </Layout>
    )
  },
  {
